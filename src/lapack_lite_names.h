...
#define qaxpy_ BLAS_FUNC(qaxpy)
#define qbdsdc_ BLAS_FUNC(qbdsdc)
#define qbdsqr_ BLAS_FUNC(qbdsqr)
#define qcabs1_ BLAS_FUNC(qcabs1)
#define qcopy_ BLAS_FUNC(qcopy)
#define qdot_ BLAS_FUNC(qdot)
#define qgebak_ BLAS_FUNC(qgebak)
#define qgebal_ BLAS_FUNC(qgebal)
#define qgebd2_ BLAS_FUNC(qgebd2)
#define qgebrd_ BLAS_FUNC(qgebrd)
#define qgeev_ BLAS_FUNC(qgeev)
#define qgehd2_ BLAS_FUNC(qgehd2)
#define qgehrd_ BLAS_FUNC(qgehrd)
#define qgelq2_ BLAS_FUNC(qgelq2)
#define qgelqf_ BLAS_FUNC(qgelqf)
#define qgelsd_ BLAS_FUNC(qgelsd)
#define qgemm_ BLAS_FUNC(qgemm)
#define qgemv_ BLAS_FUNC(qgemv)
#define qgeqr2_ BLAS_FUNC(qgeqr2)
#define qgeqrf_ BLAS_FUNC(qgeqrf)
#define qger_ BLAS_FUNC(qger)
#define qgesdd_ BLAS_FUNC(qgesdd)
#define qgesv_ BLAS_FUNC(qgesv)
#define qgetf2_ BLAS_FUNC(qgetf2)
#define qgetrf_ BLAS_FUNC(qgetrf)
#define qgetrs_ BLAS_FUNC(qgetrs)
#define qhseqr_ BLAS_FUNC(qhseqr)
#define qisnan_ BLAS_FUNC(qisnan)
#define qlabad_ BLAS_FUNC(qlabad)
#define qlabrd_ BLAS_FUNC(qlabrd)
#define qlacpy_ BLAS_FUNC(qlacpy)
#define qladiv_ BLAS_FUNC(qladiv)
#define qlae2_ BLAS_FUNC(qlae2)
#define qlaed0_ BLAS_FUNC(qlaed0)
#define qlaed1_ BLAS_FUNC(qlaed1)
#define qlaed2_ BLAS_FUNC(qlaed2)
#define qlaed3_ BLAS_FUNC(qlaed3)
#define qlaed4_ BLAS_FUNC(qlaed4)
#define qlaed5_ BLAS_FUNC(qlaed5)
#define qlaed6_ BLAS_FUNC(qlaed6)
#define qlaed7_ BLAS_FUNC(qlaed7)
#define qlaed8_ BLAS_FUNC(qlaed8)
#define qlaed9_ BLAS_FUNC(qlaed9)
#define qlaeda_ BLAS_FUNC(qlaeda)
#define qlaev2_ BLAS_FUNC(qlaev2)
#define qlaexc_ BLAS_FUNC(qlaexc)
#define qlahqr_ BLAS_FUNC(qlahqr)
#define qlahr2_ BLAS_FUNC(qlahr2)
#define qlaisnan_ BLAS_FUNC(qlaisnan)
#define qlaln2_ BLAS_FUNC(qlaln2)
#define qlals0_ BLAS_FUNC(qlals0)
#define qlalsa_ BLAS_FUNC(qlalsa)
#define qlalsd_ BLAS_FUNC(qlalsd)
#define qlamc1_ BLAS_FUNC(qlamc1)
#define qlamc2_ BLAS_FUNC(qlamc2)
#define qlamc3_ BLAS_FUNC(qlamc3)
#define qlamc4_ BLAS_FUNC(qlamc4)
#define qlamc5_ BLAS_FUNC(qlamc5)
#define qlamch_ BLAS_FUNC(qlamch)
#define qlamrg_ BLAS_FUNC(qlamrg)
#define qlange_ BLAS_FUNC(qlange)
#define qlanst_ BLAS_FUNC(qlanst)
#define qlansy_ BLAS_FUNC(qlansy)
#define qlanv2_ BLAS_FUNC(qlanv2)
#define qlapy2_ BLAS_FUNC(qlapy2)
#define qlapy3_ BLAS_FUNC(qlapy3)
#define qlaqr0_ BLAS_FUNC(qlaqr0)
#define qlaqr1_ BLAS_FUNC(qlaqr1)
#define qlaqr2_ BLAS_FUNC(qlaqr2)
#define qlaqr3_ BLAS_FUNC(qlaqr3)
#define qlaqr4_ BLAS_FUNC(qlaqr4)
#define qlaqr5_ BLAS_FUNC(qlaqr5)
#define qlarf_ BLAS_FUNC(qlarf)
#define qlarfb_ BLAS_FUNC(qlarfb)
#define qlarfg_ BLAS_FUNC(qlarfg)
#define qlarft_ BLAS_FUNC(qlarft)
#define qlarfx_ BLAS_FUNC(qlarfx)
#define qlartg_ BLAS_FUNC(qlartg)
#define qlas2_ BLAS_FUNC(qlas2)
#define qlascl_ BLAS_FUNC(qlascl)
#define qlasd0_ BLAS_FUNC(qlasd0)
#define qlasd1_ BLAS_FUNC(qlasd1)
#define qlasd2_ BLAS_FUNC(qlasd2)
#define qlasd3_ BLAS_FUNC(qlasd3)
#define qlasd4_ BLAS_FUNC(qlasd4)
#define qlasd5_ BLAS_FUNC(qlasd5)
#define qlasd6_ BLAS_FUNC(qlasd6)
#define qlasd7_ BLAS_FUNC(qlasd7)
#define qlasd8_ BLAS_FUNC(qlasd8)
#define qlasda_ BLAS_FUNC(qlasda)
#define qlasdq_ BLAS_FUNC(qlasdq)
#define qlasdt_ BLAS_FUNC(qlasdt)
#define qlaset_ BLAS_FUNC(qlaset)
#define qlasq1_ BLAS_FUNC(qlasq1)
#define qlasq2_ BLAS_FUNC(qlasq2)
#define qlasq3_ BLAS_FUNC(qlasq3)
#define qlasq4_ BLAS_FUNC(qlasq4)
#define qlasq5_ BLAS_FUNC(qlasq5)
#define qlasq6_ BLAS_FUNC(qlasq6)
#define qlasr_ BLAS_FUNC(qlasr)
#define qlasrt_ BLAS_FUNC(qlasrt)
#define qlassq_ BLAS_FUNC(qlassq)
#define qlasv2_ BLAS_FUNC(qlasv2)
#define qlaswp_ BLAS_FUNC(qlaswp)
#define qlasy2_ BLAS_FUNC(qlasy2)
#define qlatrd_ BLAS_FUNC(qlatrd)
#define qlauu2_ BLAS_FUNC(qlauu2)
#define qlauum_ BLAS_FUNC(qlauum)
#define qnrm2_ BLAS_FUNC(qnrm2)
#define qorg2r_ BLAS_FUNC(qorg2r)
#define qorgbr_ BLAS_FUNC(qorgbr)
#define qorghr_ BLAS_FUNC(qorghr)
#define qorgl2_ BLAS_FUNC(qorgl2)
#define qorglq_ BLAS_FUNC(qorglq)
#define qorgqr_ BLAS_FUNC(qorgqr)
#define qorm2l_ BLAS_FUNC(qorm2l)
#define qorm2r_ BLAS_FUNC(qorm2r)
#define qormbr_ BLAS_FUNC(qormbr)
#define qormhr_ BLAS_FUNC(qormhr)
#define qorml2_ BLAS_FUNC(qorml2)
#define qormlq_ BLAS_FUNC(qormlq)
#define qormql_ BLAS_FUNC(qormql)
#define qormqr_ BLAS_FUNC(qormqr)
#define qormtr_ BLAS_FUNC(qormtr)
#define qpotf2_ BLAS_FUNC(qpotf2)
#define qpotrf_ BLAS_FUNC(qpotrf)
#define qpotri_ BLAS_FUNC(qpotri)
#define qpotrs_ BLAS_FUNC(qpotrs)
#define qrot_ BLAS_FUNC(qrot)
#define qscal_ BLAS_FUNC(qscal)
#define qstedc_ BLAS_FUNC(qstedc)
#define qsteqr_ BLAS_FUNC(qsteqr)
#define qsterf_ BLAS_FUNC(qsterf)
#define qswap_ BLAS_FUNC(qswap)
#define qsyevd_ BLAS_FUNC(qsyevd)
#define qsymv_ BLAS_FUNC(qsymv)
#define qsyr2_ BLAS_FUNC(qsyr2)
#define qsyr2k_ BLAS_FUNC(qsyr2k)
#define qsyrk_ BLAS_FUNC(qsyrk)
#define qsytd2_ BLAS_FUNC(qsytd2)
#define qsytrd_ BLAS_FUNC(qsytrd)
#define qtrevc_ BLAS_FUNC(qtrevc)
#define qtrexc_ BLAS_FUNC(qtrexc)
#define qtrmm_ BLAS_FUNC(qtrmm)
#define qtrmv_ BLAS_FUNC(qtrmv)
#define qtrsm_ BLAS_FUNC(qtrsm)
#define qtrti2_ BLAS_FUNC(qtrti2)
#define qtrtri_ BLAS_FUNC(qtrtri)
#define qzasum_ BLAS_FUNC(qzasum)
#define qznrm2_ BLAS_FUNC(qznrm2)
